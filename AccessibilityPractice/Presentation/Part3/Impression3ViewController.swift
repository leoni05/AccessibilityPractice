//
//  Impression3ViewController.swift
...
class Impression3ViewController: PresentationViewController {
    ...
    override func viewDidLoad() {
        ...
        contentLabel.text = "접근성 관련 법률 준수."
...
private extension Impression3ViewController {
